...
public class PacienteControllerTest {
	...
	void setup() {
		...
		this.medico2.setUser(medico2User);
	...
	void testProcessFindFormMedNoPacientesFound() throws Exception {
    	...
    	@WithMockUser(value = "spring")
	@Test
	void testInitUpdatePacientesFormSuccess() throws Exception {
        BDDMockito.given(this.userService.getCurrentMedico()).willReturn(this.medico1);
    	...
    	@WithMockUser(value = "spring")
	@Test
	void testInitUpdatePacientesFormWrongMedico() throws Exception {
...
//				.andExpect(model().attributeHasFieldErrors("paciente", "domicilio"))
	...
	//	.andExpect(model().attribute("message", "Paciente borrado exitosamiente"))
	...
	void testBorrarPacienteSuccess() throws Exception {
        ...
        @WithMockUser(value = "spring")
	@Test
	void testBorrarPacienteSuccessInactivo() throws Exception {
    	Collection<Cita> citas = new ArrayList<Cita>();
    	Cita newCita = new Cita();
    	newCita.setFecha(LocalDate.now().minus(Period.ofYears(6)));
    	newCita.setLugar("Hospital Virgen del Rocio");
    	newCita.setPaciente(this.javier);
        ...
        @WithMockUser(value = "spring")
	@Test
	void testBorrarPacienteSuccessInactivoWithHistoriaClinica() throws Exception {
     	HistoriaClinica hc = new HistoriaClinica();
		hc.setDescripcion("Descripcion historia clinica");
        ...
        @WithMockUser(value = "spring")
	@Test
	void testBorrarPaciente5YearsApart() throws Exception {
    	Collection<Cita> citas = new ArrayList<Cita>();
    	Cita newCita = new Cita();
    	newCita.setFecha(LocalDate.now().minusYears(5));
    	newCita.setLugar("Hospital Virgen del Rocio");
...
//    		authorities.setAuthority("medico");
	...
	void testBorrarPacienteMedicoDisabled() throws Exception {
        this.medico1.getUser().setEnabled(false);
        this.javier.getMedico().getUser().setEnabled(false);
	    BDDMockito.given(this.userService.getCurrentMedico()).willReturn(this.medico1);
	    BDDMockito.given(this.pacienteService.findPacienteById(BDDMockito.anyInt())).willReturn(Optional.of(this.javier));
	    BDDMockito.given(this.medicoService.getMedicoById(BDDMockito.anyInt())).willReturn(this.medico1);
        ...
        @WithMockUser(value = "spring")
	@Test
	void testBorrarPacienteCitasFuturo() throws Exception {
    	Collection<Cita> citas = new ArrayList<Cita>();
    	Cita newCita = new Cita();
    	newCita.setFecha(LocalDate.now().plus(Period.ofDays(1)));
    	newCita.setLugar("Hospital Virgen del Rocio");
    	newCita.setPaciente(this.javier);
        ...
        @WithMockUser(value = "spring")
	@Test
	void testBorrarPacienteActivo() throws Exception {
    	Collection<Cita> citas = new ArrayList<Cita>();
    	Cita newCita = new Cita();
    	newCita.setFecha(LocalDate.now().minus(Period.ofDays(1)));
    	newCita.setLugar("Hospital Virgen del Rocio");
    	newCita.setPaciente(this.javier);
        ...
        @WithMockUser(value = "spring")
	@Test
	void testBorrarPaciente5YearsApartTomorrow() throws Exception {
    	Collection<Cita> citas = new ArrayList<Cita>();
    	Cita newCita = new Cita();
    	newCita.setFecha(LocalDate.now().minusYears(5).plusDays(1));
    	newCita.setLugar("Hospital Virgen del Rocio");
