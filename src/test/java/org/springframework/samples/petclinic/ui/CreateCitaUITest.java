...
public class CreateCitaUITest {
  ...
  public void testCrearCita() throws Exception {
    ...
    driver.findElement(By.id("lugar")).sendKeys("Hospital de Hospitalet");
    driver.findElement(By.id("fecha")).click();
    driver.findElement(By.linkText(Integer.toString(LocalDate.now().getDayOfMonth()))).click();
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals(LocalDate.now().format(DateTimeFormatter.ISO_LOCAL_DATE).toString(), driver.findElement(By.xpath("//table[@id='citasTable']/tbody/tr/td")).getText());
    assertEquals("Hospital de Hospitalet", driver.findElement(By.xpath("//table[@id='citasTable']/tbody/tr/td[2]")).getText());
  }
