...
public class CreatePacienteWithEmptyFechaNacimientoUITest {
	...
	public void testCreatePacienteWithoutFormaContactoUI() throws Exception {
	    ...
	    try {
	        assertEquals("no puede ser null", driver.findElement(By.xpath("//form[@id='add-paciente-form']/div/div[3]/div/span[2]")).getText());
	      } catch (Error e) {
