...
public class CreatePacienteWithInvalidDNI2UITest {
	...
	public void testCreatePacienteWithoutFormaContactoUI() throws Exception {
	    ...
	    try {
	        assertEquals("DNI invalido.", driver.findElement(By.xpath("//form[@id='add-paciente-form']/div/div[4]/div/span[2]")).getText());
	      } catch (Error e) {
