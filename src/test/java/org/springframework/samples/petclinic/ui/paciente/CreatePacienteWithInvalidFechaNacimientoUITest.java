...
public class CreatePacienteWithInvalidFechaNacimientoUITest {
	...
	public void testCreatePacienteWithoutFormaContactoUI() throws Exception {
	    ...
	    try {
	        assertEquals("Failed to convert property value of type java.lang.String to required type java.time.LocalDate for property f_nacimiento; nested exception is org.springframework.core.convert.ConversionFailedException: Failed to convert from type [java.lang.String] to type [@javax.validation.constraints.PastOrPresent @org.springframework.format.annotation.DateTimeFormat @javax.validation.constraints.NotNull java.time.LocalDate] for value 123; nested exception is java.lang.IllegalArgumentException: Parse attempt failed for value [123]", driver.findElement(By.xpath("//form[@id='add-paciente-form']/div/div[3]/div/span[2]")).getText());
	      } catch (Error e) {
