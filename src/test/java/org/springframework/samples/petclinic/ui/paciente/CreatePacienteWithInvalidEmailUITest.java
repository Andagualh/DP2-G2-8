...
public class CreatePacienteWithInvalidEmailUITest {
	...
	public void testCreatePacienteWithoutFormaContactoUI() throws Exception {
	    ...
	    try {
	        assertEquals("no es una dirección de correo bien formada", driver.findElement(By.xpath("//form[@id='add-paciente-form']/div/div[7]/div/span[2]")).getText());
	      } catch (Error e) {
