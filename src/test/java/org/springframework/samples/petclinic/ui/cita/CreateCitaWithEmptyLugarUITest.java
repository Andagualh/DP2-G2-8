...
public class CreateCitaWithEmptyLugarUITest {
	...
	private int port = 8080;
	  ...
	  public void testUntitledTestCase() throws Exception {
	    ...
	    //driver.findElement(By.linkText("Christian Ochoa Moran")).click();
	    ...
	    driver.findElement(By.xpath("//input[@id='fecha']")).click();
	    driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/table/tbody/tr[3]/td[4]/a")).click();
	    driver.findElement(By.xpath("//button[@type='submit']")).click();
	    driver.findElement(By.xpath("//form[@id='add-cita-form']/div/div/div/span[2]")).click();
	    assertEquals("no puede estar vacío", driver.findElement(By.xpath("//form[@id='add-cita-form']/div/div/div/span[2]")).getText());
	  }
