...
public class CreateCitaWithEmptyFechaUITest {
	...
	private WebDriver driver;
	  ...
	  public void testCrearCitaFechaVacio() throws Exception {
	    ...
	    driver.findElement(By.xpath("//button[@type='submit']")).click();
	    assertEquals("no puede ser null", driver.findElement(By.xpath("//form[@id='add-cita-form']/div/div[2]/div/span[2]")).getText());
	  }
