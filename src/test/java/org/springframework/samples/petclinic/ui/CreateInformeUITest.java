...
public class CreateInformeUITest {
  ...
  @LocalServerPort
    ...
    @Test
    public void testCreateInformeUI() throws Exception {
      ...
      driver.findElement(By.xpath("//a[contains(@href, '/citas/new/1')]")).click();
      driver.findElement(By.id("lugar")).click();
      driver.findElement(By.id("lugar")).clear();
      driver.findElement(By.id("lugar")).sendKeys("Reina Mercedes S/N");
      driver.findElement(By.id("fecha")).click();
      driver.findElement(By.linkText(Integer.toString(LocalDate.now().getDayOfMonth()))).click();
      assertEquals(LocalDate.now().format(DateTimeFormatter.ISO_LOCAL_DATE).toString(), driver.findElement(By.id("fecha")).getAttribute("value"));
      driver.findElement(By.xpath("//button[@type='submit']")).click();
      driver.findElement(By.linkText("Crear Informe")).click();
      driver.findElement(By.id("motivo_consulta")).click();
      driver.findElement(By.id("motivo_consulta")).clear();
      driver.findElement(By.id("motivo_consulta")).sendKeys("Picor en la frente");
      driver.findElement(By.xpath("//form[@id='add-informe-form']/div[2]/div")).click();
      driver.findElement(By.id("diagnostico")).click();
      driver.findElement(By.id("diagnostico")).clear();
      driver.findElement(By.id("diagnostico")).sendKeys("Dermatitis");
      assertEquals("Picor en la frente", driver.findElement(By.id("motivo_consulta")).getAttribute("value"));
      assertEquals("Dermatitis", driver.findElement(By.id("diagnostico")).getAttribute("value"));
